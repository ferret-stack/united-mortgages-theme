...
<script src="<?php echo get_template_directory_uri(); ?>/js/aip-form-components-v2.js?v=3.3.1"></script>
<script src="<?php echo get_template_directory_uri(); ?>/js/aip-form-app-v2.js?v=3.3.1"></script>
