...
<main id="primary" class="site-main">
        ...
        <div class="hp-container">
            ...
            <div class="um-diff-grid">
                <div class="um-diff-card">
                    ...
                    <h4>Helping you manage mortgage chain risk</h4>
                    <p>A mortgage chain break can delay, or derail, your entire move. With our end-to-end support, we help manage your property chain, coordinating with our partners from estate agents to conveyancing solicitors to keep your home move on track.</p>
                </div>

                <div class="um-diff-card">
                    <p class="um-diff-card__index">02</p>
                    <h4>365 Days. Until 8 PM.</h4>
                    <p>Most brokers close before your shift ends. We don't. We're available 365 days a year. If you have a question at 7:30 PM on a Sunday, we're here.</p>
                </div>
                ...
                <div class="um-diff-card">
                    ...
                    <h4>Moving home mortgages built around your goals</h4>
                    <p>Whether you're upsizing your home, downsizing property, or relocating, match you to the right moving home mortgage options.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="um-compare">
        <div class="hp-container">
            <div class="um-section-header">
                <h2 class="um-section-title">Outgrowing your space? Looking to downsize?</h2>
            </div>
                ...
                <table class="um-compare-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Generic affordability assesment</td>
                            <td class="um-highlight">Holistic mortgage advice factoring in cost of living and its impacts on repayments, rates, and housing prices</td>
                        </tr>
                        <tr>
                            <td>Porting vs. Bridging</td>
                            <td>Simple either/or</td>
                            <td class="um-highlight">Structure the deal that works for your situation - mortgage porting, bridging finance, or lifetime ISA</td>
                        </tr>
                        <tr>
    ...
    <section class="um-faq">
        <div class="hp-container">
            ...
            <div class="faq-list">
                ...
                <div class="faq-item">
                    <button class="faq-question" aria-expanded="false">
                        Which moving home mortgage options should I choose?
                        <span class="faq-icon" aria-hidden="true"></span>
                    </button>
                    <div class="faq-answer">
                ...
                <div class="faq-item">
                    <button class="faq-question" aria-expanded="false">
                        What is bridging finance and how is it used to buy a property?
                        <span class="faq-icon" aria-hidden="true"></span>
                    </button>
                    <div class="faq-answer">
                ...
                <div class="faq-item">
                    <button class="faq-question" aria-expanded="false">
                        What mortgage deposit help is available in the UK?
                        <span class="faq-icon" aria-hidden="true"></span>
                    </button>
                    <div class="faq-answer">
