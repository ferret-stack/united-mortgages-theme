<?php
/**
 * Template Name: NHS Mortgage Programme
 * 
...
<main id="primary" class="site-main">
    ...
    <!-- Hero Section -->
        <section class="hero-section other-mortgages-hero nhs">
            <div class="hero-overlay"></div>
            <div class="nhs-hero-bottom">
                <div class="nhs-hero-text">
                    <h1>Mortgages for the <span class="highlight">24/7 Hero</span></h1>
                    <p class="nhs-hero-tagline">Your shift ends. Our work begins.</p>
                </div>
                ...
                <table style="width:100%; border-collapse:collapse; background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 2px 12px rgba(0,0,0,0.06);">
                    ...
                    <tbody>
                        <tr style="border-bottom:1px solid #eee;">
                            ...
                            <td style="padding:1rem 1.5rem; color:#666;">9–5 (Mon–Fri)</td>
                        ...
                        <tr style="border-bottom:1px solid #eee;">
                            ...
                            <td style="padding:1rem 1.5rem; color:#666;">Often viewed as an outgoing</td>
                            <td style="padding:1rem 1.5rem; color:#1a1a1a; font-weight:500;">Recognised as a career benefit</td>
                        </tr>
    ...
    <section class="features-section" style="background:#1a1a1a; padding:5rem 0;">
        <div class="container">
            <h2 style="color:#fff; font-size:2rem; font-weight:300; text-align:center; margin-bottom:1rem;">
                Ready when <strong>you are</strong>
            </h2>
