...
<main id="primary" class="site-main">
    ...
    <section class="hero-section chorleywood">
        <div class="hero-overlay"></div>
        <div class="hero-content">
            <h1 class="hero-title geography">Your mortgage advisers in <span class="highlight">Chorleywood</h1>
        </div>
...
<!-- Calculator Container -->
    ...
    <section class="hero-section calculator-hero rickmansworth">
        <div class="hero-overlay"></div>
        <div class="container">
            <div class="hero-content">
        ...
        if (resultsDisplay) {
            ...
            setTimeout(function() {
                ...
                if (!resultsDisplay.querySelector('.results-cta')) {
                    ...
                    ctaDiv.innerHTML = '<a href="https://2eys75.share-eu1.hsforms.com/2CyHMlBwuTZuTCr2F8SfDhw" class="btn-primary" style="cursor: pointer; display: inline-block;">Get Expert Mortgage Advice</a>';
