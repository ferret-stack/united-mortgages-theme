...
<main id="primary" class="site-main">
    ...
    <section class="hero-section northwood">
        <div class="hero-overlay"></div>
        <div class="hero-content">
            <h1 class="hero-title geography">Your mortgage advisers in</h1>
        </div>
...
<!-- Calculator Container -->
    ...
    <section class="hero-section calculator-hero northwood">
        <div class="hero-overlay"></div>
        <div class="container">
            <div class="hero-content">
