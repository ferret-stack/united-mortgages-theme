...
<main id="primary" class="site-main">
    ...
    <section class="um-diff">
        <div class="hp-container">
            <div class="um-section-header">
                <h2 class="um-section-title">The <span class="bold-text">United Mortgages&reg;</span> Difference</h2>
            </div>

            <div class="um-diff-grid">
                <div class="um-diff-card">
                    <p class="um-diff-card__index">01</p>
                    <h4>The 'Help-to-Buy' Support That Goes Beyond Money</h4>
                    <p>Beginning the home buying process could be a life-changing experience. We are here to 'help to buy' with detailed guidance on steps to buying a first home in the UK, easy-to-use <a href="/calculators" target="_blank">affordability calculators</a>, and human support 365 days a year to support your journey.</p>
                </div>

                <div class="um-diff-card">
                    <p class="um-diff-card__index">02</p>
                    <h4>365 Days. Until 8 PM.</h4>
                    <p>Most brokers close before your shift ends. We don't. Whether you're finishing a night shift or starting a weekend rotation, we're available 365 days a year. If you have a question at 7:30 PM on a Sunday, we're here.</p>
                </div>

                <div class="um-diff-card">
                    <p class="um-diff-card__index">03</p>
                    <h4>The No-Day-Off Application</h4>
                    <p>You've got enough on your plate. Our process is 100% digital. Upload your documents from your phone in the breakroom. Sign your papers from your sofa. No fax machines, no branch visits, no nonsense.</p>
                </div>

                <div class="um-diff-card">
                    <p class="um-diff-card__index">04</p>
                    <h4>Understand Your Deposit Options and Borrowing Potential</h4>
                    <p>'How much can I borrow for a mortgage in the UK', 'Deposit required for first time buyer'... The answer isn't a simplified calculated number. We go beyond basic calculators - assessing your full profile to identify lenders whose criteria may support your borrowing needs, including options where you may borrow up to 5.5&ndash;6&times; income (subject to criteria and mortgage affordability).</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Comparison Table -->
    <section class="um-compare">
        <div class="hp-container">
            <div class="um-section-header">
                <h2 class="um-section-title">Your first home deserves more than a tick-box mortgage</h2>
            </div>

            <div class="um-compare-table-wrap">
                <table class="um-compare-table">
                    <thead>
                        <tr>
                            <th>Feature</th>
                            <th>The High Street</th>
                            <th class="um-highlight">United Mortgages&reg;</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>Opening Hours</td>
                            <td>9&ndash;5 (Mon&ndash;Fri)</td>
                            <td class="um-highlight">Until 8 PM, 365 Days a Year</td>
                        </tr>
                        <tr>
                            <td>&pound;50,000+ Student Loan</td>
                            <td>Viewed as an unfavourable factor</td>
                            <td class="um-highlight">Compare the best mortgage options for first time buyers, based on your situation</td>
                        </tr>
                        <tr>
                            <td>Single Income vs. Shared Ownership</td>
                            <td>May focus on standard options such as shared ownership</td>
                            <td class="um-highlight">Bespoke first time buyer mortgage options aligned to your goals</td>
                        </tr>
                        <tr>
                            <td>Application Process</td>
                            <td>Paper-heavy &amp; slow</td>
                            <td class="um-highlight">Digital-first &amp; lightning fast</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <section class="um-cta-band">
        <div class="hp-container">
            <h2 class="um-cta-band__title">Ready to take <strong>the first step?</strong></h2>
            ...
            <div class="um-cta-band__actions">
                ...
                <a href="#contact-form" class="hp-btn hp-btn--outline">Speak to an Adviser</a>
            </div>
        </div>
    </section>

    <!-- FAQ -->
    <section class="um-faq">
        <div class="hp-container">
            <div class="um-section-header">
            ...
            <div class="faq-list">
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <ol>
                            ...
                            <li>Secure an <a href="/aip-form" target="_blank">Agreement in Principle</a> (so your budget is confirmed and you can start viewing)</li>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <!-- Mortgage options for first time buyers blog link here -->
                    </div>
                </div>
                ...
                <div class="faq-item">
                    <button class="faq-question" target="_blank" aria-expanded="false">
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <p>Calculate your stamp duty using <a href="/calculators#stamp-duty" target="_blank">our calculator</a>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        ...
                        <!--Buy to let for first time buyers post here -->
                    </div>
                </div>
