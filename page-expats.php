...
<main id="primary" class="site-main">
        ...
        <div class="hp-container">
            ...
            <div class="um-diff-grid">
                ...
                <div class="um-diff-card">
                    ...
                    <p>Brokers closing before your day has even begun? We won't. We're available 365 days a year. If you have a question at 7:30 PM on a Sunday, we're here.</p>
                </div>
                ...
                <div class="um-diff-card">
                    ...
                    <p>Need clarification on stamp duty, property tax, or being an overseas landlord? We know the UK mortgage landscape and are ready to help you navigate your expat mortgage.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="um-compare">
        <div class="hp-container">
            <div class="um-section-header">
                <h2 class="um-section-title">United Kingdom mortgages <span class="bold-text">tailored for expats</span></h2>
            </div>
                ...
                <table class="um-compare-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="um-highlight">Until 8 PM (GMT), 365 Days a Year</td>
                        </tr>
                        <tr>
                            <td>Deposit &amp; Affordability Requirements</td>
                            <td>Higher thresholds with limited flexibility</td>
                            <td class="um-highlight">We work within lender criteria to identify competitive expat mortgage options suited to your profile</td>
                        </tr>
                        <tr>
                            <td>Nationality &amp; Visa Status</td>
                            <td>Generic overseas category</td>
                            <td class="um-highlight">Tailored guidance factoring in your visa type, residency status, and non-domiciled mortgage considerations</td>
                        </tr>
                        <tr>
                            <td>Application Process</td>
                            <td>Paper-heavy &amp; slow</td>
                            <td class="um-highlight">100% digital &ndash; no branch visits, no time zone barriers</td>
                        </tr>
                    </tbody>
                </table>
            </div>
